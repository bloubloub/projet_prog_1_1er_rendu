...
val movsd: [`D] operand -> [`D] operand -> text
...
val addsd: [`D] operand -> [`D] operand -> text
...
val subsd: [`D] operand -> [`D] operand -> text

val imulw: [`W] operand -> [`W] operand -> text
val imull: [`L] operand -> [`L] operand -> text
val imulq: [`Q] operand -> [`Q] operand -> text
val mulsd: [`D] operand -> [`D] operand -> text

val idivq: [`Q] operand -> text
val cqto: text

val cvtsd2siq: [`D] operand -> [`Q] operand -> text
val cvtsi2sdq: [`Q] operand -> [`D] operand -> text
...
val pushsd: [`D] operand -> text
  (** [pushsd r] décrémente de 8 le stack pointer et place le contenu de [r] sur l'espace 
  libéré, permettant d'empiler le contenu d'un double sur la pile**)

val popsd: [`D] operand -> text
  (** [popsd r] place le double en sommet de pile dans [r] et incrémente le stack pointer
  de 8, permettant de dépiler et de pointer vers la valeur suivante **)
(** {2 Divers } *)
